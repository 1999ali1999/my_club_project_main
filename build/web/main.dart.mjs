...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AG: x0 => x0.minWidth,
      AH: (x0,x1) => x0.lock(x1),
      AI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      iG: (x0,x1) => { x0.name = x1 },
      iH: x0 => x0.buffer,
      iI: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      vH: (x0,x1) => { x0.src = x1 },
      vI: (handle) => clearInterval(handle),
      vJ: x0 => x0.metaKey,
      ...
      yH: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
