...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BI: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ...
      DI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      DJ: x0 => x0.disabled,
      DK: x0 => x0.getReader(),
      E: (exn) => {
      ...
      NJ: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      ...
      OJ: (x0,x1) => globalThis.fetch(x0,x1),
      ...
      QI: x0 => new Blob(x0),
      QJ: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1,x2) { return wasmFunction(f,arguments.length,x0,x1,x2) }),
      ...
      RI: (x0,x1,x2) => x0.set(x1,x2),
      RJ: (x0,x1) => x0.forEach(x1),
      ...
      SH: x0 => x0.first(),
      SI: (x0,x1,x2,x3,x4) => ({type: x0,data: x1,premultiplyAlpha: x2,colorSpaceConversion: x3,preferAnimation: x4}),
      SJ: x0 => x0.name,
      T: x0 => new Promise(x0),
      ...
      TH: x0 => x0.next(),
      TI: x0 => new window.ImageDecoder(x0),
      TJ: x0 => x0.statusText,
      ...
      cG: (x0,x1) => { x0.type = x1 },
      cH: x0 => x0.done,
      cI: (x0,x1) => ({frameIndex: x0,completeFramesOnly: x1}),
      cJ: x0 => x0.headers,
      d: (o, p) => o[p],
